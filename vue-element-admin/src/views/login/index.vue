<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="registerForm" class="login-form" autocomplete="on" label-position="left">
      ...
      <el-form-item label="用户名：">
        <el-input v-model="registerForm.data"/>
      </el-form-item>
      ...
      <el-row>
        <el-col :span="12"><el-link type="primary">忘记密码？</el-link></el-col>
        <el-col :span="12" style="text-align: right;"><el-link type="primary" @click="handleRegister">注册</el-link></el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      const encryptedPassword = CryptoJS.SHA256(this.loginForm.password).toString()
        ...
        .then(() => {
          ...
          axios.post('http://localhost:5000/login', formData)
            .then(response => {
              ...
              if (this.form['message'] == 'Login successful') {
                this.$router.push({ path: this.redirect || '/', query: this.otherQuery })
              } else {
